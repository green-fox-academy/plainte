...
int main(void)
{
	...
	TimHandle.Init.Prescaler = (10800 - 1) * 2; /* 108000000/10800=10000 -> speed of 1 count-up: 1/10000 sec = 0.05ms */
	TimHandle.Init.Period = 10000 - 1; /* 10000 x 0.05 ms = 0.5 second period */
